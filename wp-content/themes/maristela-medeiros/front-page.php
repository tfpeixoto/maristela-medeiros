	...
	<div class="jumbotron">
		...
		<div class="row">
			<div class="col-12 col-md-8 text-center text-md-left">
				<?php query_posts('page_id=5'); if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
...
<main>
			...
			<div class="row d-flex align-items-center justify-content-center">
				<?php query_posts('page_id=2'); if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
					...
					<div class="col-10 col-md-5">
						<img src="<?php the_post_thumbnail_url(); ?>" class="card-img-top" alt="Nutricionista Maristela Medeiros, especialista em segurança dos alimentos" />
					</div>
	...
	<div id="cta" class="bg-cinza text-white py-5 py-md-3">
		<div class="container">
			<div class="row">
				<?php query_posts('page_id=26'); if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>

					<div class="col-12 col-md-5">
						<img src="<?php the_post_thumbnail_url(); ?>" class="img-fluid" alt="Atendimento nutricional especializado para empresas" />
					</div>
						...
						<?php while(have_posts()): the_post(); ?>
							...
							<div class="col-12 col-md-6 mb-5 mb-md-0">
								<div class="media row d-flex justify-content-center justify-content-md-left align-items-center">
									<a href="#" data-toggle="modal" data-target="#tab-<?php the_id(); ?>"><?php the_post_thumbnail( 'img-depoimento' ); ?></a>
									<div class="media-body col-12 col-md-8 text-center text-md-left">							    
										...
										<h5 class="mt-3 font-weight-bold"><a href="#" data-toggle="modal" data-target="#tab-<?php the_id(); ?>"><?php the_title(); ?></a></h5>
									</div>
								</div>						
							</div>

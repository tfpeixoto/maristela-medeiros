...
Contributors: p0rthas, lysyiweb, freemius
...
**[MPG](https://mpgwp.com/?utm_source=wp-repo&utm_medium=link&utm_campaign=readme)** is the solution for web developers and SEO professionals that want to create multiple pages in bulk under the same domain. 
...
With the **[MPG: Multiple Pages Generator](https://mpgwp.com/?utm_source=wp-repo&utm_medium=link&utm_campaign=readme)** WordPress plugin, you can keep your website lean and fast and still generate an unlimited number of webpages with customized content using just one template page and a CSV file.
...
The MPG plugin is the ultimate mass landing page creator plugin. And it's easier to use than you think, check out **[how it works](https://www.mpgwp.com/?utm_source=wp-repo&utm_medium=link&utm_campaign=readme)**:
...
Grab search engines’ attention and direct them to your new pages. **MPG: Multiple Pages Generator plugin** has an **[additional sitemap generator tool](https://www.mpgwp.com/help/generating-sitemap/?utm_source=wp-repo&utm_medium=link&utm_campaign=readme)** that automatically creates a sitemap of your new pages to search engines.

### GENERATE INTERNAL LINKS 

Create a user-friendly experience on your website by [creating lists of internal links](https://www.mpgwp.com/help/generating-lists-inlinks/?utm_source=wp-repo&utm_medium=link&utm_campaign=readme) that you can add anywhere in your website. 
...
Enjoy the [Multiple Pages Generator plugin](https://www.mpgwp.com/?utm_source=wp-repo&utm_medium=link&utm_campaign=readme) for free to create up to 50 incredible new pages for your website.

###TRY A DEMO

Discover how easy-to-use **MPG** is and sign up to [try out a demo version](https://www.mpgwp.com/#try-demo/?utm_source=wp-repo&utm_medium=link&utm_campaign=readme). Simply sign up and follow the link you get in your email. You’ll have access to a sample database file and a sample template page and you can alter them as much as you like to see how much MPG can do for your website.

### TRY MPG PRO

Forget the 50-page limit with **[MPG Pro](https://www.mpgwp.com/?utm_source=wp-repo&utm_medium=link&utm_campaign=readme)** and create as many new pages as you like in minutes, thousands, tens of thousands, hundreds of thousands and more. Become unlimited with **MPG Pro**.
...
Follow us on [Twitter](https://twitter.com/MPGWordpress) or [Facebook](https://twitter.com/MPGWordpress)
...
The [Multiple Pages Generator](https://mpgwp.com/?utm_source=wp-repo&utm_medium=link&utm_campaign=readme) plugin is perfect for creating an unlimited number of landing pages with personalized content and searchable URLs from easily manageable templates and database files (offline or online).
...
Yes, check out our tutorial videos and step-by-steps at [mpgwp.com/help](https://www.mpgwp.com/help/?utm_source=wp-repo&utm_medium=link&utm_campaign=readme)

**Is the MPG plugin free?**

You can use all the features of the plugin for free to create up to 50 pages in bulk. To create an unlimited amount of landing pages, you can upgrade your plan. Check out our incredible deals here: [mpgwp.com](https://www.mpgwp.com?utm_source=wp-repo&utm_medium=link&utm_campaign=readme)
...
E-mail us at [mpg@porthas.com](mailto:mpg@porthas.com)

...
== Screenshots ==
1. Adicione banners em massa em qualquer lugar do conteúdo
2. Acompanhe os resultados dentro do WordPress
3. Faça o upload do banner
4. Escolha onde e quando os banners devem aparecer

== Frequently Asked Questions ==

### Como instalar o Rock Convert?
[https://rock-content.gitbook.io/rock-convert/setup-e-configuracao](https://rock-content.gitbook.io/rock-convert/setup-e-configuracao)

### Links úteis
[O que é CTA: Tudo o que você precisa saber](https://marketingdeconteudo.com/o-que-e-cta/?utm_source=wordpress&utm_medium=plugin&utm_campaign=cta)
[Entenda o que são os parâmetros UTM do Google Analytics e como eles podem ser úteis para suas campanhas](https://marketingdeconteudo.com/parametros-utm-do-google-analytics/)
...
= 2.1.3 =
Correção:
* Previne que aconteça o Fatal Error na função get_rest_url
...
== Upgrade Notice ==
Esta versão inclui diversas novas funcionalidades como:
* Analytics: saiba como seus CTAs estão performando diretamente no painel do wordpress;
* Visibilidade: Agora é possível escolher páginas onde um banner não deve aparecer;
* Shortcode: Todo banner tem um shortcode único que pode ser adicionado em qualquer posição de qualquer conteúdo;
* Captura de leads: Disponibilize seus posts para download no formato PDF e capture os e-mails;

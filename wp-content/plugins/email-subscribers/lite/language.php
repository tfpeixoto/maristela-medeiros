...
__( 'Icegram Express (formerly known as Email Subscribers & Newsletters) Premium', 'email-subscribers' ),
...
__( '<span id="footer-thankyou">Thank you for creating with <a href="%1$s" target="_blank">WordPress</a> | Icegram Express (formerly known as Email Subscribers & Newsletters) <b>%2$s</b>. Developed by team <a href="%3$s" target="_blank">Icegram</a></span>', 'email-subscribers' ),
...
__( 'Welcome To Icegram Express (formerly known as Email Subscribers & Newsletters)', 'email-subscribers' ),
...
__( 'If you found duplicate campaigns, lists, forms, reports after upgrading from Icegram Express (formerly known as Email Subscribers & Newsletters) 3.5.x to 4.x and want to run the database migration again to fix this, please click the below %1$sRun the updater%2$s button.', 'email-subscribers' ),
/* translators: 1. Starting strong tag 2. Closing strong tag */
...
__( 'Or use <strong><a href="%s" target="_blank">Icegram Express (formerly known as Email Subscribers & Newsletters) Pro</a></strong> for automatic Cron support', 'email-subscribers' ),
...
__( '<b>Icegram Express (formerly known as Email Subscribers & Newsletters) Secret Club</b>', 'email-subscribers' ),
__( 'Join Now', 'email-subscribers' ),
__( 'Icegram Express (formerly known as Email Subscribers & Newsletters) MAX', 'email-subscribers' ),
...
__( 'Congratulations! You just unlocked %s on Icegram Express (formerly known as Email Subscribers & Newsletters) Premium!', 'email-subscribers' ),
/* translators: %s: Offer text */
...
__( ' More powerful features with Icegram Express (formerly known as Email Subscribers & Newsletters) Premium!', 'email-subscribers' ),
...
/* translators: %s: Pricing page URL */
__( 'Icegram Express (formerly known as Email Subscribers & Newsletters)', 'email-subscribers' ),
...
__( 'Enable this option if you do not want Icegram Express (formerly known as Email Subscribers & Newsletters) to use WP Cron to send emails.', 'email-subscribers' ),
...
__( 'Help us to improve Icegram Express (formerly known as Email Subscribers & Newsletters) by opting in to share non-sensitive plugin usage data.', 'email-subscribers' ),
...
__( 'Please select list.', 'email-subscribers' ),
__( 'Icegram Express (formerly known as Email Subscribers & Newsletters) Cronjob Interval', 'email-subscribers' ),
...
__( 'Icegram Express (formerly known as Email Subscribers & Newsletters) Form', 'email-subscribers' ),
...
__( 'Hey!!! now sync users using Icegram Express (formerly known as Email Subscribers & Newsletters)\' workflows. <a href="%s" class="text-indigo-400">Create new workflows</a>', 'email-subscribers' ),
...
__( 'Yes', 'email-subscribers' ),
__( 'No', 'email-subscribers' ),
__( 'Allow Icegram Express (formerly known as Email Subscribers & Newsletters) to track plugin usage. It will help us to understand your issue better. We guarantee no sensitive data is collected.', 'email-subscribers' ),
__( 'Not a member yet?', 'email-subscribers' ),
__( 'Join', 'email-subscribers' ),
__( 'Icegram Express (formerly known as Email Subscribers & Newsletters) Secret Club', 'email-subscribers' ),
__( 'on Facebook', 'email-subscribers' ),
__( '<span><p>We hope you\'re enjoying <b>Icegram Express (formerly known as Email Subscribers & Newsletters)</b> plugin! Could you please do us a BIG favor and give us a 5-star rating on WordPress to help us spread the word and boost our motivation?</p>', 'email-subscribers' ),
...
__( 'Icegram Express (formerly known as Email Subscribers & Newsletters) PRO', 'email-subscribers' ),
__( 'You can allow different user roles access to different operations within Icegram Express (formerly known as Email Subscribers & Newsletters) plugin. Please select which roles should have what access below.', 'email-subscribers' ),
...
__( 'Icegram Express (formerly known as Email Subscribers & Newsletters) Starter', 'email-subscribers' ),
...
__( 'Avoid manual actions and make your workflow quick, simple and effortless by integrating popular WordPress plugins with Icegram Express (formerly known as Email Subscribers & Newsletters) MAX.', 'email-subscribers' ),
...
/* translators: 1. Bold tag 2. Bold close tag */
__( 'Want to track some very useful statistics of your campaigns and improve your future campaign ? Upgrade to %1$s Icegram Express (formerly known as Email Subscribers & Newsletters) MAX %2$s and measure the effectiveness of your campaigns.', 'email-subscribers' ),
__( 'List(s): ', 'email-subscribers' ),
...
__( 'How to configure Mailgun to send emails in the  Icegram Express (formerly known as Email Subscribers & Newsletters) plugin?', 'email-subscribers' ),
__( 'How to configure SendGrid to send emails in the  Icegram Express (formerly known as Email Subscribers & Newsletters) plugin?', 'email-subscribers' ),
__( 'How to configure Sparkpost to send emails in the  Icegram Express (formerly known as Email Subscribers & Newsletters) plugin?', 'email-subscribers' ),
__( 'How to configure Amazon SES to send emails in the  Icegram Express (formerly known as Email Subscribers & Newsletters) plugin?', 'email-subscribers' ),
__( 'How to configure Postmark to send emails in the  Icegram Express (formerly known as Email Subscribers & Newsletters) plugin?', 'email-subscribers' ),
__( 'How to configure Sendinblue to send emails in the Icegram Express (formerly known as Email Subscribers & Newsletters) plugin?', 'email-subscribers' ),
__( 'How to configure Mailjet to send emails in the Icegram Express (formerly known as Email Subscribers & Newsletters) plugin?', 'email-subscribers' ),
...
__( 'Please authorize GMail to send Email using Icegram Express (formerly known as Email Subscribers & Newsletters) plugin.', 'email-subscribers' ),
...
__( 'How to configure Gmail to send emails in the Icegram Express (formerly known as Email Subscribers & Newsletters) plugin?', 'email-subscribers' ),
